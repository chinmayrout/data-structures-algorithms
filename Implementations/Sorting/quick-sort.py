...
def partition(start, end, array):
    ...
    #Returning end pointer to diviide the array into 2
    return end
...
def quick_sort(start, end, array):
    ...
    if start < end:
        #p is the partition index, array[p] is at the right place
